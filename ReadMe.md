...
The per-language `*Harvest.wxi` includes are generated by the build, not edited by hand. In other places, the list is built dynamically using something like `<LocaleDirs Include="$([System.IO.Directory]::GetDirectories(&quot;$(L10nsDirectory)&quot;))"/>` (these do not need to be updated).
